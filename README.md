...
## Common issues ##
###*NOTE:* I'm on vacation. Don't expect fast responses.
You can find answers to most questions by using the search box at the top of this page (switch to the desktop version if you don't see it) or the [issue tracker](https://github.com/SimenCodes/heads-up/issues?q=is%3Aissue).
#### If no popups appear: ####
